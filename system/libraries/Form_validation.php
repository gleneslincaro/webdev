...
class CI_Form_validation {
	...
	public function encode_php_tags($str)
	{
        ...
        * @return  boolen
        */
        public function checkStringByte($obj) {

            if(strlen($obj) != mb_strlen($obj,'utf8'))
            {
                return false;
            }
            return true;
        ...
        public function hiragana($str)
        {
         ...
         /**
        * @autho [IVS]Trieu Nguyen Bao
        * @name	validNumber
        * @todo	Check number format for number and '-' : 12345678, 12-2345-45, 7894-897-8
        * @param	null
        * @return  boolen
        */
        function validNumber($obj)
        {
            ...
            for($i=0; $i< sizeof($str_ar); $i++){
                ...
                foreach ($patern as $value) {
                   ...
                   {
                       if((!is_numeric($str_ar[$i])) && ($str_ar[$i] != '-') )
                        {
                             return false;
                        }
                   }
		 ...
		 * @return	bool
		 */
		public function checkSelect($str)
		{
			if ( ! is_array($str))
			{
				return (trim($str) == '') ? FALSE : TRUE;
