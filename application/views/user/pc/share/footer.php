<footer>
	<div class="footer_inner cf">
		<div class="l_column">
			<a href="<?php echo base_url(); ?>"><img src="<?php echo base_url().'public/user/pc/'; ?>image/footer_logo.png" width="204" height="63" alt="風俗求人・高収入アルバイト情報ジョイスペ"></a>
		...
		<div class="r_column">
			...
			<small class="copyright">Copyright &copy; <a href="https://www.joyspe.com/" >風俗の求人なら高収入アルバイトのジョイスペ</a> All Rights Reserved.</small> </div>
	</div>
</footer>
