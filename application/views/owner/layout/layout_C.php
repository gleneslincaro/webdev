...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja">
    <head>
        ...
        <script type="text/javascript" src="<?php echo base_url();?>public/owner/js/jquery.sticky-placeholder.js"></script>
        <script type="text/javascript" src="<?php echo base_url();?>public/owner/js/jquery.linkformat.js"></script>
        <script type="text/javascript" src="<?php echo base_url();?>public/owner/js/jquery-migrate.js"></script>
    ...
    <body oncontextmenu ="return false">
        ...
        <?php $this->load->view('owner/share/header_layoutC'); ?>
