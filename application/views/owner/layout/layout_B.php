...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja">
    <head>
        ...
        <script language="javascript" src="<?php echo base_url() ?>public/owner/js/jquery-form.js"></script>
        <script language="javascript" src="<?php echo base_url() ?>public/owner/js/popup.js"></script>
