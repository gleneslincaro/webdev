                        ...
                        <div class="form_preview experiences_list management"> <img src="/public/user/pc/image/bg1.png">
                            ...
                            <div class="form_preview experiences_list">
                                ...
                                <div class="position_center">
                                    <input type="text" class="title posting_form ttl" title="50文字以内で入力してください" maxlength="50" required="" placeholder="50文字以内で入力してください">
                                </div>
                            </div>
                            <div class="form_preview experiences_list">
                                <h4 class="experiences_post_h">本文1000文字以内</h4>
                                <div class="position_center">
                                    <textarea type="text" class="content posting_form content" title="1000文字以内で入力してください" maxlength="1000" required="" placeholder="1000文字以内で入力してください"></textarea>
                                </div>
                                <div class="position_center"> <a class="experiences_send_btn" rel="leanModal" href="#experiences_send_modal"> 投稿する</a> </div>
                                <div id="experiences_send_modal" class="position_center">
                                    <p>投稿しますか？</p>
                                    <a class="experiences_send experiences_send_btn" rel="leanModal" href="#experiences_send_modal_2"> 投稿する</a> <a class="cancel_btn">キャンセル</a> </div>
