  <a class="body"> 
    ...
    <div id="center_text">
    <font color="#0099ff">
        <a class="body"> <?php echo $divsuccess; ?></a>
    </font>
    </div>

<form method="post" action="<?php echo base_url() ?>user/certificate/certificate_after" enctype="multipart/form-data">
    ...
    <input type="submit" class="btn" value="登録する" name="btn" />
    <br >
