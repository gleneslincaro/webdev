...
<?php
  foreach ($detail_owners as $data) {
    ...
    <div class="box">
      <div class="box_title"><?php echo $data['storename']; ?></div>
      <div class="box_in">
      ...
      <?php endif ?>
        ...
        <div class="kyujin">
          ...
          <dl>
            ...
            <em class="btn_line">
            ID:</span><input id="contact_line" type="text" value="<?php echo $data['line_id']; ?>" onfocus="this.selectionStart=0; this.selectionEnd=this.value.length;" onmouseup="return false"></em></a><?php endif ?>
            </dd>
      ...
      <div class="box" style="margin-top:1rem;">
        <div class="oubo_btn">
            ...
            <div id="layer_【お祝い】" style="display: none;position:relative;margin-left:15pt" class="close">
              ...
              <p style="text-align:center;">
              現在店舗様が勤務確認を行っております。<br />
              お祝い金のお支払いまで今しばらくお待ちください。
              </p>
            </div>
        </div>
    </div>
