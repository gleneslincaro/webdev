...
<section class="section--main_content_area">
    <div class="container cf">
        <div class="box_white">
            <form method="post" action="<?php echo base_url().'user/keep/keep_complete'?>" enctype="multipart/form-data" id="form_keep">
            ...
            <input type="hidden" name="type_page" value="<?php echo $type_page;?>"/>
                <section class="section--denial">
                    <div class="denial">
                        ...
                        <p class="confirmation"><?php echo $storename; ?>をキープしますか？</p>
                    </div>
                    <div class="select_btn">
                        <ul>
                            <li> <a class="ui_btn ui_btn--large ui_btn btn_keep" href="javascript:void(0)" id="keep"></a> </li>
