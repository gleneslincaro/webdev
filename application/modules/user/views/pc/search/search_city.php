				...
				<dl>
					...
					<dd>
						<ul>
							...
							<li>
							<a href="<?php echo base_url().'user/jobs/'.$group_city.'/'.$value1['alph_name'].'/'.$value2['alph_name'].'/' ?>" class="<?php echo isset($value2['ocount']) ? : ' off' ; ?>" ><?php echo $value2['name']; ?></a>
<!--							<a href="<?php echo base_url().'user/jobs/'.$group_city.'/'.$value1['alph_name'].'/'.$value2['alph_name'].'/' ?>" class="<?php echo ($value2['active_flag'])? :' off' ; ?>" ><?php echo $value2['name']; ?></a> -->
							</li>
							<?php endforeach; ?>
						</ul>
					</dd>
