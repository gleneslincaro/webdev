<section class="section--store_list">
	<?php foreach ($storeOwner as $key => $data): ?>
		...
		<div class="store_box_1">
			<h3 class="store_name"><!-- <span class="tag tag-new">NEW</span>--><?php echo $data['storename']; ?></h3>
			<p class="desc_1">
			...
			<div class="box_wrap cf">
				<div class="box_left">
					...
					<p class="desc_2"><?php echo $this->common->_japanese_character_limiter($data['company_info'],150); ?></p>
				</div><!-- // .box_left -->
				<div class="box_right">
					<div class="data_2">
						<table>
...
<!--                        <p>体入お祝い金<strong>10,000</strong>円</p>  -->
					<p><?php echo $data['happy_money_type']; ?>お祝い金<strong><?php echo number_format($data['happy_money']); ?></strong>円</p>
					</div>
					<?php endif;?>
					<div class="guarantee">
							<ul class="traffic">
							<?php if( isset($travel_expense)) : ?>
								<li>
									<p class="traffic_bn"><?php echo number_format($data['travel_expense_bonus']); ?></p>
								</li>
							<?php endif;?>
							<?php if( isset($campaignBonusRequest)) : ?>
								<li>
									<p class="trial_bn"><?php echo number_format($data['bonus_money']); ?></p>
								</li>
							<?php endif;?>
							</ul>
					</div>
					<ul class="btn_wrap">
						<li>
							<?php if ($data['keepstt']==0) : ?>
								<a href="<?php echo base_url() . "user/keep/index/" . $data["orid"]; ?>/" class="ui_btn btn_keep ui_btn--small"></a>
							<?php else : ?>
								<a href="<?php echo base_url() . "user/keep/keep_clear/" . $data["orid"]; ?>/" class="ui_btn btn_keep on ui_btn--small"></a>
							<?php endif; ?>
						</li>
						<li>
...
<!--
	<ul>
		...
		<li><a href="#" class="disabled">01</a></li>
		<li><a href="#">02</a></li>
		<li><a href="#">03</a></li>
		<li><a href="#">04</a></li>
		<li><a href="#">05</a></li>
