...
<form name="forms" method="post" action="<?php echo base_url(); ?>index.php/admin/setting/doUpdateHour" onsubmit="return confirm('編集しますか？');">
...
<th style="border:1px solid #000000;background-color:#808080;color:#FFFFFF;text-align:center;">時給目安&nbsp;</th>
<th style="border:1px solid #000000;background-color:#808080;color:#FFFFFF;text-align:center;">アクティブ&nbsp;</th>
</tr>
<?php
    foreach ($hourSalaryList as $row): 
?>
<tr>
...
<button type="button" <?php  echo 'onClick="{location.href=\''.base_url().'index.php/admin/setting/addHour\'}"' ?>>　追加　</button><input type="submit" value="　編集　" >
</p>
</form>
</center>