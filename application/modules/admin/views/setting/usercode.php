<script language='javascript'>
            $(document).ready(function(){
                checkValidationBeforeDeleteUserCode();
            })
</script>
<script language="javascript">
    $(document).ready(function(){
        ...
        window.location=base+"admin/setting/addUserCode";
    });
...
<form name="forms" method="post" action="<?php echo base_url(); ?>index.php/admin/setting/checkBeforeDeleteUserCode">
...
<?php 
    if($flag == 1){
?>
<input type="hidden" id="txtFlagCheckboxUC" name="txtFlagCheckboxUC" value="<?php echo $flag ?>">
<input type="hidden" id="txtErrorUC" name="txtErrorUC" value="<?php echo $error_message ?>">
<?php 
    }
    if($flag == 2){
?>
<input type="hidden" id="txtFlagCheckboxUC" name="txtFlagCheckboxUC" value="<?php echo $flag ?>">
<input type="hidden" id="txtArrayUC" name="txtArrayUC" value="<?php foreach ($array1 as $key=>$c): echo $key;echo "_";endforeach;?>">
<?php 
    }
?>
<?php
    foreach ($userCodeList as $row): 
?>
<tr>
...
<button type="button" id="btnset4">　追加　</button>　<input type="submit" value="　削除　" >
