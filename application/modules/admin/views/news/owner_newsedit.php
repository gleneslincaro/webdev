...
<script language="javascript">
    $(document).ready(function(){
           checkUpdateFlag_NewsForOwnerToUpdate();
           setCurrentDate();
            })
</script>
<?php
...
echo '<form  method="post" action="'.base_url().'index.php/admin/news/showEditNewForOwner?newId=';
...
<td style="border:1px solid #000000;"><input type="text" name="txtTitle" id="txtTitle"  maxlength="200" size="100" value="'.$txtTitle.'"></td>
</tr>
