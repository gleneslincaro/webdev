<script language="javascript">
    $(document).ready(function(){
            pagingByAjax();
           checkUpdateFlag_NewsForOwnerToInsert();
           setCurrentDate();
            })
</script>
<?php
...
echo '<form action="'.base_url().'index.php/admin/news/checkValidateFormOwner" method="post">';            
echo '<center>
<p>オーナー側・ニュース</p>
</center>
...
<td style="border:1px solid #000000;">
<textarea name="txtContent" id="txtContent" cols="65"  maxlength="50000" rows="20">';
...
if($info!=null){
    foreach($info as $k=>$item){    
        echo '<tr>
            ...
            <td>'.$item["title"].'</td>
            <td><input type="button" value="　編集　" onClick="{location.href=\''.base_url().'index.php/admin/news/showEditNewForOwner?newId='.$item["id"].'\'}">&nbsp;</td>
