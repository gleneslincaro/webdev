...
echo '<form action="'.base_url().'index.php/admin/mail/checkValidateFormOwner" method="post">';
...
echo '<input type="hidden" value="1" name="txtType" id="txtType"/>'; 
echo '<center>
<p>メルマガ作成</p>
</center>
...
<div style="margin:0px;padding:0px;" align="center" width="50%">
...
<tbody>
<tr>
<td style="border:1px solid #000000;"><span id="aspan">送信内容</span></td>
...
<option value="求人担当者">求人担当者</option>
...
<option value="店舗地域">店舗地域</option>
<option value="店舗職種">店舗職種</option>
<option value="店舗最寄駅">店舗最寄駅</option>
<option value="店舗時給目安">店舗時給目安</option>
<option value="店舗月給目安">店舗月給目安</option>
</select>
</td>
...
<tr>
<td style="border:1px solid #000000;">配信アドレス&nbsp;</td>
<td colspan="3">
