...
<center>
    ...
    <p>キャンペーン告知</p>
    <p><a href="<?php echo base_url(); ?>admin/campaign/ownercampaingnall">キャンペーン一覧はこちら</a></p>
    ...
    <form method="post">
        <table>
            ...
            <tr>
                <td>期間</td>
                <td><input id="start_date" type="text" name="start_date" value="<?php echo set_value("start_date"); ?>"> ~ <input id="end_date" type="text" name="end_date" value="<?php echo set_value("end_date"); ?>"></td>
            </tr>
            <tr>
                <td>リンク</td>
                <td><input type="text" name="link" value="<?php echo set_value("link"); ?>"></td>
            </tr>
            <tr>
                <td>状態</td>
                <td>
