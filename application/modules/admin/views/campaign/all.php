...
$(function() {
  $(".campaign-close").click(function(){
    ...
    $.ajax({
      type:"POST",
      url:"<?php echo base_url(); ?>admin/campaign/stopCampaign",
...
<p>面接交通費支援キャンペーン一覧</p>
<p><a href="<?php echo base_url(); ?>admin/campaign/create">キャンペーン作成はこちら</a></p>
  <div>
      ...
      <tbody>
        ...
        <?php foreach ($campaigns as $campaign) {
          ...
          <?php } ?>
            ...
            <td><?php echo $campaign['travel_expense']; ?></td>
