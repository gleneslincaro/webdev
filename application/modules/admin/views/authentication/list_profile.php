<script language="javascript">
    $(document).ready(function(){
        ...
        $("#btApprove").click(function(){
            window.location=base+"admin/authentication/ok_Profile/"+$("#txtowid").val();        
        });
...
<center>
    <p>オリジナル文章<br>
        ※連絡先が記載されていた場合は「修正」から編集を行ってください。写真も注意！<br>
        ※問題なければそのまま「承認」して下さい。<br>
    </p>
        ...
        <tr>
            ...
            <td align="center">
                <div class="photo_box">
                    ...
                    <?php }else{ ?>
                        <div class="photo" style="margin-right:25px;"><img id="image1" name="image1" width="100" height="60" src="<?php echo base_url();?>public/owner/uploads/images/<?php echo $owinfo["image1"];?>" /></div>
                    <?php }
                    if($owinfo['image2']==''){ ?>
