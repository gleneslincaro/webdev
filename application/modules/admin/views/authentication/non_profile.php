<script type="text/javascript">
    $(document).ajaxStart($.blockUI).ajaxStop($.unblockUI);
     $(document).ready(function(){
            ...
            var txtercenter=$("#txtercenter").val();
        if(flag!=null && flag!=""){
            bol=window.confirm("登録しますか？");
            if(bol==true){
                $("#txtflag").val("");
                $.ajax({
                    url:base+"admin/authentication/updateNon_Profile",
                    type:"post",
            ...
            +"&hdImage6="+image6+"&txtmainimg="+main+"&txtercenter="+txtercenter+"&id="+rid,
                    async:true,
                    success:function(kq){
...
echo "<form action='".base_url()."admin/authentication/non_Profile/".$ow["reid"]."' method='post'  enctype='multipart/form-data' id='form_ow'>";
...
if($ow["image1"]=="" && $ow["image1"]==null){
    if(isset($image1) && $image1!=""){
        echo '<div class="photo" style="margin-right:25px;"><img id="image1" name="image1" width="100" height="60" src="'. base_url()."public/owner/uploads/tmp/".$image1.'" /></div>';
    }else{
        echo '<div class="photo" style="margin-right:25px;"><img id="image1" name="image1" width="100" height="60" src="'.  base_url().'public/owner/images/no_image.jpg" /></div>';
    }
}else{
    if(isset($image1)&& $image1!=""){
        if($image1==$ow["image1"]){
            echo '<div class="photo" style="margin-right:25px;"><img id="image1" name="image1" width="100" height="60" src="'. base_url()."public/owner/uploads/images/".$image1.'" /></div>';
        }else{
            echo '<div class="photo" style="margin-right:25px;"><img id="image1" name="image1" width="100" height="60" src="'. base_url()."public/owner/uploads/tmp/".$image1.'" /></div>';
        }
        ...
        echo '<div class="photo" style="margin-right:25px;"><img id="image1" name="image1" width="100" height="60" src="'. base_url()."public/owner/uploads/images/".$ow["image1"].'" /></div>';
    }
}
if($ow["image2"]=="" && $ow["image2"]==null){
   if(isset($image2) && $image2!=""){
        echo '<div class="photo" style="margin-right:25px;"><img id="image2" name="image2" width="100" height="60" src="'. base_url()."public/owner/uploads/tmp/".$image2.'" /></div>';
    }else{
        echo '<div class="photo" style="margin-right:25px;"><img id="image2" name="image2" width="100" height="60" src="'.  base_url().'public/owner/images/no_image.jpg" /></div>';
    }
}else{
    if(isset($image2) && $image2!=""){
        if($image2==$ow["image2"]){
             echo '<div class="photo" style="margin-right:25px;"><img id="image2" name="image2" width="100" height="60" src="'. base_url()."public/owner/uploads/images/".$image2.'" /></div>';
        }else{
            echo '<div class="photo" style="margin-right:25px;"><img id="image2" name="image2" width="100" height="60" src="'. base_url()."public/owner/uploads/tmp/".$image2.'" /></div>';
        }
        ...
        echo '<div class="photo" style="margin-right:25px;"><img id="image2" name="image2" width="100" height="60" src="'.  base_url()."public/owner/uploads/images/".$ow["image2"].'" /></div>';
    } 
}
if($ow["image3"]=="" && $ow["image3"]==null){
   if(isset($image3) && $image3!=""){
        echo '<div class="photo"><img id="image3" name="image3" width="100" height="60" src="'. base_url()."public/owner/uploads/tmp/".$image3.'" /></div>';
    }else{
        echo '<div class="photo"><img id="image3" name="image3" width="100" height="60" src="'.  base_url().'public/owner/images/no_image.jpg" /></div>';
    }  
}else{
    if(isset($image3) && $image3!=""){
        if($image3==$ow["image3"]){
            echo '<div class="photo"><img id="image3" name="image3" width="100" height="60" src="'. base_url()."public/owner/uploads/images/".$image3.'" /></div>';
        }else{
            echo '<div class="photo"><img id="image3" name="image3" width="100" height="60" src="'. base_url()."public/owner/uploads/tmp/".$image3.'" /></div>';
        }
       ...
       echo '<div class="photo"><img id="image3" name="image3" width="100" height="60" src="'.  base_url()."public/owner/uploads/images/".$ow["image3"].'"></div>';
    }    
}
...
if($ow["image4"]=="" && $ow["image4"]==null){
    if(isset($image4) && $image4!=""){
        echo '<div class="photo" style="margin-right:25px;"><img id="image4" name="image4" width="100" height="60" src="'. base_url()."public/owner/uploads/tmp/".$image4.'" /></div>';
    }else{
        echo '<div class="photo" style="margin-right:25px;"><img id="image4" name="image4" width="100" height="60" src="'.  base_url().'public/owner/images/no_image.jpg" /></div>';
    } 
    
}else{
    if(isset($image4) && $image4!=""){
         if($image4==$ow["image4"]){
            echo '<div class="photo" style="margin-right:25px;"><img id="image4" name="image4" width="100" height="60" src="'. base_url()."public/owner/uploads/images/".$image4.'" /></div>';
        }else{
            echo '<div class="photo" style="margin-right:25px;"><img id="image4" name="image4" width="100" height="60" src="'. base_url()."public/owner/uploads/tmp/".$image4.'" /></div>';
        }
       ...
       echo '<div class="photo" style="margin-right:25px;"><img id="image4" name="image4" width="100" height="60" src="'.  base_url()."public/owner/uploads/images/".$ow["image4"].'"></div>';
    }        
}
if($ow["image5"]=="" && $ow["image5"]==null){
     if(isset($image5) && $image5!=""){
        echo '<div class="photo" style="margin-right:25px;"><img id="image5" name="image5" width="100" height="60" src="'. base_url()."public/owner/uploads/tmp/".$image5.'" /></div>';
    }
    else{
        echo '<div class="photo" style="margin-right:25px;"><img id="image5" name="image5" width="100" height="60" src="'.  base_url().'public/owner/images/no_image.jpg" /></div>';
    } 
}else{
      if(isset($image5) && $image5!=""){
         if($image5==$ow["image5"]){
            echo '<div class="photo" style="margin-right:25px;"><img id="image5" name="image5" width="100" height="60" src="'. base_url()."public/owner/uploads/images/".$image5.'" /></div>';
        }else{
            echo '<div class="photo" style="margin-right:25px;"><img id="image5" name="image5" width="100" height="60" src="'. base_url()."public/owner/uploads/tmp/".$image5.'" /></div>';
        }
       ...
       echo '<div class="photo" style="margin-right:25px;"><img id="image5" name="image5" width="100" height="60" src="'.  base_url()."public/owner/uploads/images/".$ow["image5"].'"></div>';
    }     
}
if($ow["image6"]=="" && $ow["image6"]==null){
 if(isset($image6) && $image6!=""){
        echo '<div class="photo"><img id="image6" name="image6" width="100" height="60" src="'. base_url()."public/owner/uploads/tmp/".$image6.'" /></div>';
    }else{
        echo '<div class="photo"><img id="image6" name="image6" width="100" height="60" src="'.  base_url().'public/owner/images/no_image.jpg" /></div>';
    } 
    
}else{
    if(isset($image6) && $image6!=""){
         if($image6==$ow["image6"]){
            echo '<div class="photo"><img id="image6" name="image6" width="100" height="60" src="'. base_url()."public/owner/uploads/images/".$image6.'" /></div>';
        }else{
            echo '<div class="photo"><img id="image6" name="image6" width="100" height="60" src="'. base_url()."public/owner/uploads/tmp/".$image6.'" /></div>';
        }
      ...
      echo '<div class="photo"><img id="image6" name="image6" width="100" height="60" src="'.  base_url()."public/owner/uploads/images/".$ow["image6"].'"></div>';
    } 
...
';
    if(isset($ernote)){
        ...
        echo set_value("txtercenter");
    }else{
        echo $ow["error_recruit_content"]; 
    }
echo'
</textarea></p>
</center>
<center>
<p> スタッフ記入欄<br>
<textarea name="txtercenter" id="txtercenter" cols="70" rows="15">
';
    if(isset($ercenter)){
        echo $ercenter;
    }else if (isset($cc)){
