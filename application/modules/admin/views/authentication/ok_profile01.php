    ...
    $(document).ready(function(){
        ...
        if(flag!=null && flag!=""){
            ...
            if(bol==true){
                $("#txtflag").val("");
                $.ajax({
                    url:base+"admin/authentication/updateOk_Profile01",
                    type:"post",
...
echo "<form action='".base_url()."admin/authentication/ok_Profile01/".$ow["reid"]."' method='post'  enctype='multipart/form-data' id='form_ow'>";
