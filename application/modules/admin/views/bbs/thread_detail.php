<div id="bbsThreadContentDetail" >
	...
	<table id="table-detail" border="1">
		<tr>
			<th colspan="6" class="header-title">スレッド詳細 <?php echo $threadDetail['create_ip']; ?></th>
		</tr>
		<tr>
			<th>投稿日</th>
			<th>大カテゴリ</th>
	...
	<table id="table-comment-detail" border="1">
		<tr>
			<th colspan="6" class="header-title">回答一覧  <?php echo $value['create_ip']; ?></th>
		</tr>
		<tr>
			<th>投稿日</th>
			<th>ユーザーID</th>
	...
	<div class="container-replay replay<?php echo $value['id']; ?>" >
		...
		<table id="table-replay-comment">
			...
			<tr>
				...
				<td><?php echo $value['reply']['like_count']; ?></td>
				<td>
					<?php
						if ($threadDetail['publish'] == 1):
					?>
...
<script type="text/javascript">
	...
	$('.load_more').click(function() {
		...
		$.ajax({
			type: "POST",
			url: '/admin/bbs/thread_detail/'+thread_id,
			data: data,
			dataType: 'HTML',
			cache: false,
			success:
