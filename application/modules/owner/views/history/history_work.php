<script type="text/javascript">
  $(document).ready(function() {
    ...
    <div class="crumb">TOP ＞ 申請一覧 ＞ 勤務確認（お祝い金・承認確認）一覧</div>
<!--
...
-->
    <div class="list-box"><!-- list-box ここから -->
        <div class="list-title">勤務確認（お祝い金・承認確認）一覧 </div>
<div class="contents-box-wrapper">
    <div class="work-list-wrapper">
        <div class="list-menu">
            <a class="pr35" href="<?php echo base_url() . 'owner/history/history_work' ?>" style=" color: rgb(0,0,0)" ><font color="#000000">勤務確認一覧</font></a>
    ...
    <div class="table-list-wrapper">
        <table>
            <tr>
                <th>ID</th><th>写真</th><th>地域</th><th>年齢</th><th>面接完了報告</th><th>勤務申請</th><th>勤務確認</th>
            </tr>
            <?php foreach ($user_data as $value): ?>
                <tr>
                    ...
                    <td><button type="button" onClick="javascript:location.href = '<?php echo base_url() . 'owner/history/history_app_work/'.$value['id'].'/'.$value['owner_recruit_id'] ?>';">確認ページ</button></a></td>
                </tr>
            <?php endforeach; ?>
        ...
        <div class="btn_box">
            ...
            if($totalpage>1) {
                 ?>
                <a href="<?php echo base_url() . 'owner/history/history_work' ?>"><img style="border: 0" src="<?php echo base_url() . 'public/owner/images/btn_back.png' ?>" alt="次へ"></a>
                <?php echo $paging; ?>
                <a href="<?php echo base_url() . 'owner/history/history_work/' . $totalpage; ?>"><img style="border: 0" src="<?php echo base_url() . 'public/owner/images/btn_next.png' ?>" alt="次へ"></a>
            <?php
            }
            ?>
        </div>
